\begin{frame}
  ...
  \path[fill={rgb,255:red,{{answer.content[0]}}; green,{{answer.content[1]}}; blue,{{answer.content[2]}}}] ($(question)+(90+{{loop.index0}}*36:4.7cm)$) circle (0.5cm);
  {% else %}
  ...
  \node[optionnode] (logo) at ($(current page.north)+(4cm,-0.2cm)$) {\large \bfseries \textcolor{black}{CLEVER}\textcolor{white}{10}};
